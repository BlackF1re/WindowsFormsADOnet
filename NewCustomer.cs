...
namespace WindowsFormsADOnet
{
    public partial class NewCustomer : Form
    {
                ...
                using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.connString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand("Sales.uspNewCustomer", connection))
                    {
                        ...
                        try
                        {
                            ...
                            // Отправка Customer ID в RO textbox
                            txtCustomerID.Text = Convert.ToString(parsedCustomerID);
                        }
                        catch
                        {
                            MessageBox.Show("Customer ID не возвращен. Аккаунт не может быть создан.");
                        }
                        finally
                        {
                            connection.Close();
        ...
        private void BtnAddFinish_Click(object sender, EventArgs e) => Close();

        private void BtnAddAnotherAccount_Click(object sender, EventArgs e) => ClearForm();
